                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary card-outline no-radius">
                            <div class="card-body">
                                <form action="{{ route('schoolbest-packages.store') }}" method="post">
                                    @csrf
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4 mb-5">
                                            ...
                                            <input type="text" name="monthly" class="form-control form-control-border @error('monthly') is-invalid @enderror no-radius" value="{{ old('monthly') }}" >
                                        ...
                                        <div class="col-md-4 mb-5">
                                            ...
                                            <input type="text" name="termly" class="form-control form-control-border @error('termly') is-invalid @enderror no-radius" value="{{ old('termly') }}">
                                        ...
                                        <div class="col-md-4 mb-5">
                                            ...
                                            <input type="text" name="yearly" class="form-control form-control-border @error('yearly') is-invalid @enderror no-radius" value="{{ old('yearly') }}">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-outline-primary btn-flat float-right">
