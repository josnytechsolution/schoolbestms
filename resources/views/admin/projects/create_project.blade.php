                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary card-outline no-radius">
                            <div class="card-body">
                                <form action="{{ route('schoolbest-projects.store') }}" method="post">
                                    @csrf
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4 mb-5">
                                            ...
                                            <input type="date" name="next_due_date" class="form-control form-control-border @error('next_due_date') is-invalid @enderror no-radius" value="{{ old('next_due_date') }}">
