...
<head>
    ...
    <title>{{ config('app.name', 'SchoolBest MS') }}</title>
...
<body class="hold-transition sidebar-mini layout-fixed text-sm" style="font-family: Nunito">
<div class="wrapper">
    <!-- Navbar -->
                        ...
                        <div class="card card-outline card-primary no-radius">
                            ...
                            <div class="card-body">
                                <div class="col-md-12 mb-4">
                                    <input type="text" id="code" class="form-control form-control-border" />
                                </div>
                                <div class="col-md-12">
                                    <table class="table">
                                        <thead>
